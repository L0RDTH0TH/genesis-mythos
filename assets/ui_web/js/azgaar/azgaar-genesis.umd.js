(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, factory(global.AzgaarGenesis = {}));
  ...
  function calculateMoisture(cellId, pack, grid) {
    ...
    const moistAround = neighbors[cellId].filter((neibCellId) => heights[neibCellId] >= MIN_LAND_HEIGHT).map((c) => prec[gridReference[c]]).concat([moisture]);
  ...
  function assignBiomes({ pack, grid, options, biomesData: providedBiomesData = null }) {
    ...
    for (let cellId = 0; cellId < heights.length; cellId++) {
      ...
      const moisture = height < MIN_LAND_HEIGHT ? 0 : calculateMoisture(cellId, pack, grid);
  ...
  let SimplePriorityQueue$2 = class SimplePriorityQueue {
    constructor() {
      this.items = [];
    }
    push(item, priority) {
  ...
  let SimplePriorityQueue$1 = class SimplePriorityQueue {
    constructor() {
      this.items = [];
    }
    push(item, priority) {
  ...
  function drawLakes(ctx, { grid, pack, options }) {
    ...
    for (const feature of features) {
      ...
      ctx.fillStyle = lakeGroup === "saltwater" ? STYLE_CONSTANTS.lakeSaltwater : STYLE_CONSTANTS.lakeFreshwater;
  ...
  function initGenerator({ canvas = null } = {}) {
    if (state.initialized) {
      throw new InitializationError(
  ...
  exports2.assignBiomes = assignBiomes;
  exports2.assignColors = assignColors;
  exports2.calculateMapCoordinates = calculateMapCoordinates;
  exports2.calculateTemperatures = calculateTemperatures;
  exports2.collectStatistics = collectStatistics;
  exports2.createVoronoiDiagram = createVoronoiDiagram;
  exports2.expandCultures = expandCultures;
  exports2.expandStates = expandStates;
  exports2.findGridCell = findGridCell;
  exports2.generateBurgs = generateBurgs;
  exports2.generateCultureEmblems = generateCultureEmblems;
  exports2.generateCultures = generateCultures;
  exports2.generateEmblem = generateEmblem;
  exports2.generateEmblems = generateEmblems;
  exports2.generateHeightmap = generateHeightmap;
  exports2.generateMap = generateMap;
  exports2.generatePrecipitation = generatePrecipitation;
  exports2.generateProvinces = generateProvinces;
  exports2.generateReligionEmblems = generateReligionEmblems;
  exports2.generateReligions = generateReligions;
  exports2.generateRivers = generateRivers;
  exports2.generateStateEmblems = generateStateEmblems;
  exports2.generateStates = generateStates;
  exports2.getDefaultBiomes = getDefaultBiomes;
  exports2.getDefaultOptions = getDefaultOptions;
  exports2.getMapData = getMapData;
  exports2.initGenerator = initGenerator;
  exports2.loadOptions = loadOptions;
  exports2.markupGrid = markupGrid;
  exports2.markupPack = markupPack;
  exports2.mergeOptions = mergeOptions;
  exports2.normalizeStates = normalizeStates;
  exports2.renderPreview = renderPreview;
  exports2.specifyFeatures = specifyFeatures;
  Object.defineProperty(exports2, Symbol.toStringTag, { value: "Module" });
});
//# sourceMappingURL=azgaar-genesis.umd.js.map
