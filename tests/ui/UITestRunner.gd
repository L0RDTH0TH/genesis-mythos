# ╔═══════════════════════════════════════════════════════════
# ║ UITestRunner.gd
# ║ Desc: Automated test runner for UI test suite
# ║ Author: Lordthoth
# ╚═══════════════════════════════════════════════════════════
...
func _ready() -> void:
	"""Setup and run UI tests automatically."""
...
func _setup_config() -> void:
	"""Configure GUT to run UI tests."""
	_config = GutConfig.new()
	_config.options.dirs = ['res://tests/ui']
	_config.options.include_subdirs = true
	_config.options.prefix = ''
