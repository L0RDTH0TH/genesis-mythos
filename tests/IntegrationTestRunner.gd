...
# ║ Desc: Automated test runner for GUT integration tests
# ║ Author: Lordthoth
# ╚═══════════════════════════════════════════════════════════
...
func _ready() -> void:
	"""Setup and run all integration tests automatically."""
...
func _setup_config() -> void:
	"""Configure GUT to run all integration tests."""
	_config = GutConfig.new()
	_config.options.dirs = ['res://tests/integration']
