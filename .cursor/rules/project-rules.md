# ╔═══════════════════════════════════════════════════════════
# ║ COMPLETE & FINAL PROJECT RULES – ITERATION 4
...
- Repository: (to be provided once created)
...
**THESE RULES ARE CURRENT AND AUTHORITATIVE AS OF 2025-12-17. MAJOR CHANGES REQUIRE EXPLICIT APPROVAL AND AUDIT.**

**UPDATE 2025-12-13:** ProceduralWorldMap upgraded to explicitly supported addon status (core system that generates 2D maps seeding Terrain3D procedural generation).

**UPDATE 2025-12-17:** GUI Specification integrated as Section 11. GameGUI removed; built-in responsive tools + UIConstants are now the single source of truth for UI layout and scaling.
